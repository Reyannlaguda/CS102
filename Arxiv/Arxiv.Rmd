...
url <- 'https://arxiv.org/search/cs?query=Computer+technology&searchtype=all&abstracts=show&order=-announced_date_first&size=50'
...
write.csv(papers, file = "Arxiv papers about Computer Technology.csv")
```

```{r}
library (readr)
read.csv("Arxiv/Arxiv papers about Computer Technology.csv")
```